    ...
    <div className="interior_Containor">
      <div className="interior_In">
        <div className="interior_Title">
          <span className="interior_SubTitle">Today` s Pick!!</span>
          <span className="interior_MainTitle">Interior & Plant</span>
        </div>
        <div className="interior_Main">
          <div className="interior_Text">
            <div className="interior_MainText">
              많은 사람들이 인테리어의 포인트로 조경을 선택합니다. 왤까요??
              <br />
              인위적인 공간과 유기체의 조합에 공간이 생기를 갖게되기 때문이죠.
              <br />
              실제로도 자칫 딱딱해 보일 수 있는 공간에 싱그러운 초록빛과
              <br />
              알록달록한 꽃들이 자리하면 그 분위기는 몇배는 증폭됩니다.
              <br />
              요즘은 단순한 관상용을 넘어서 식물 자체에서 내뿜는 좋은 기능들을
              보고
              <br />
              내집에 하나쯤은 두고 싶다고 생각을 하는데요~
              <br />
            </div>
            <div className="interior_SubText">
              오늘의 Pick을 담당한 인테리어 전공자 출신 Seungmin 개발자가
              추천하는
              <br />
              다양한 인테리어디자인에 어울릴 식물들을 소개합니다!
              <br />
            </div>
          </div>
        ...
        <div className="interior_Wood scroll">
          ...
          <div className="interior_WoodText">
            ...
            <div className="interior_WoodSubText">
              ...
              어디에 두어도 잘 어울리지만
              <br />
              그래도 나무와 식물의 조화엔 안되겠죠?
              <br />
              <br />
              우드소재로 이루어진 가구나 공간 주변에
              <br />
              푸릇한 조경을 추가함으로써
              <br />
              자연을 그대로 담아 가져온듯한
        ...
        <div className="interior_Modern scroll">
          <div className="interior_ModernText">
            <div className="interior_ModernMainText">Modern + Plant</div>
            <div className="interior_ModernSubText">
              시크한 모던스타일의 인테리어는
              <br />
              젊은층에게 인기가 많습니다.
              <br />
      ...
      <div className="interior_Plant">
        <div className="interior_PlantListTitle">
          <div className="interior_PlantListSubTitle">mr.Green이 추천하는</div>
          <div className="interior_PlantListMainTitle">
            인테리어디자인에 어울리는 식물
          </div>
        </div>
